...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HistoricalRole.deleted_on'
        db.delete_column(u'fm_historicalrole', 'deleted_on')

        # Deleting field 'HistoricalContact.deleted_on'
        db.delete_column(u'fm_historicalcontact', 'deleted_on')
        ...
        # Deleting field 'HistoricalArea.deleted_on'
        db.delete_column(u'fm_historicalarea', 'deleted_on')
        ...
        # Deleting field 'HistoricalFacility.deleted_on'
        db.delete_column(u'fm_historicalfacility', 'deleted_on')
    ...
    def backwards(self, orm):
        # Adding field 'HistoricalRole.deleted_on'
        db.add_column(u'fm_historicalrole', 'deleted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HistoricalContact.deleted_on'
        db.add_column(u'fm_historicalcontact', 'deleted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'HistoricalArea.deleted_on'
        db.add_column(u'fm_historicalarea', 'deleted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'HistoricalFacility.deleted_on'
        db.add_column(u'fm_historicalfacility', 'deleted_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
